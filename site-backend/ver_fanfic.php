...
while($registro = mysqli_fetch_assoc($fic))
{
	...
	echo "<div class='bloco'><hr/><p>" . $registro['texto'] . "</p><hr/><div class='bot'><button><a  class='divCRUD' href='minhas_fanfics.php?id=".$registro['id_autor']."'>Voltar</a></button></div></div>";
